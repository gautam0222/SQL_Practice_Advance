...
CREATE TABLE `availibility` (
  ...
  `AC1_SEATS` int DEFAULT NULL,
  `AC2_SEATS` int DEFAULT NULL,
  `GEN_SEATS` int DEFAULT NULL,
...
INSERT INTO `availibility` VALUES (12867,20,76,8),(23456,10,70,50),(45678,43,19,0),(98765,8,52,89);
