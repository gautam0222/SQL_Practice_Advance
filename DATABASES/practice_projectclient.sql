...
CREATE TABLE `projectclient` (
  ...
  CONSTRAINT `projectclient_ibfk_1` FOREIGN KEY (`ProjectID`) REFERENCES `project` (`ProjectID`),
  CONSTRAINT `projectclient_ibfk_2` FOREIGN KEY (`ClientID`) REFERENCES `client` (`ClientID`)
...
INSERT INTO `projectclient` VALUES (1,1),(2,2),(3,3);
