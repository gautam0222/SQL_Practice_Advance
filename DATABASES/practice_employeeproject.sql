...
CREATE TABLE `employeeproject` (
  ...
  CONSTRAINT `employeeproject_ibfk_1` FOREIGN KEY (`EmpID`) REFERENCES `employee` (`EmpID`),
  CONSTRAINT `employeeproject_ibfk_2` FOREIGN KEY (`ProjectID`) REFERENCES `project` (`ProjectID`)
...
INSERT INTO `employeeproject` VALUES (1,1,'Manager'),(2,1,'Developer'),(3,2,'HR'),(4,3,'Finance Head'),(5,2,'Developer');
...
-- Dump completed on 2026-04-01 12:20:27
